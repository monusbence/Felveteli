...
function generateTable() {
    var osszesitettPont = parseInt(document.getElementById("osszesitett").value);

    var filteredData = adatok.filter(function (item) {
        return (item.Matematika + item.Magyar) >= osszesitettPont;
    });

    var tableHTML = "<table id='data-table' border='1'><tr><th onclick='sortTable(0)'>OM Azonosito</th><th onclick='sortTable(1)'>Neve</th><th onclick='sortTable(2)'>Matematika</th><th onclick='sortTable(3)'>Magyar</th><th onclick='sortTable(4)'>Osszesitet</th></tr>";
    ...
    document.getElementById("tablazat").innerHTML = tableHTML;
}
